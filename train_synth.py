...
log_dir='logs_fov_shapes_gmm_brain_mom_brain_params_dim_'+str(dimx)+'_'+str(nb_features)+'_nc_'+str(args.nb_conv_per_level)+'_bs_'+str(args.batch_size)+'_sc_'+str(args.scale)+'_zb_'+str(args.zero_background)
models_dir='models_fov_shapes_gmm_brain_mom_brain_params_dim_'+str(dimx)+'_'+str(nb_features)+'_nc_'+str(args.nb_conv_per_level)+'_bs_'+str(args.batch_size)+'_sc_'+str(args.scale)+'_zb_'+str(args.zero_background)
...
mgh = pathlib.Path('fetus_gmm_brain_label')
...
label_maps = label_maps + feta_label_maps
